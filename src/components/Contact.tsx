...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 bg-bark relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-terracotta/10 rounded-full -translate-y-1/2 translate-x-1/2" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-olive/10 rounded-full translate-y-1/2 -translate-x-1/2" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <div>
              <span className="inline-block px-4 py-1.5 bg-cream/10 text-cream text-sm font-semibold rounded-full mb-4">
                Get In Touch
              </span>
              ...
              <p className="text-lg text-cream/70 max-w-lg">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-serif text-lg font-bold text-cream">Visit Our Farm</h3>
                  <p className="text-cream/60">123 Country Road<br />Greenfield Valley, CA 94123</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-serif text-lg font-bold text-cream">Call Us</h3>
                  <p className="text-cream/60">(555) 123-4567<br />Mon-Sat: 7AM - 6PM</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-serif text-lg font-bold text-cream">Email Us</h3>
                  <p className="text-cream/60">hello@goldenharvestfarm.com<br />orders@goldenharvestfarm.com</p>
                </div>
              </div>
            </div>
            ...
            {/* Social Links */}
            <div className="pt-6">
              <p className="text-cream/60 mb-4">Follow us on social media</p>
